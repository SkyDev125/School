...
void myfunction23() {
    ...
    while (opcao != 0)
    {
        ...
        cout << "[12] Determinar nota mais alta do aluno perante a disciplina" << endl;
        ...
        switch (opcao){
            ...
            case 2: {
                ...
                cout << "================================================================" << endl;
                cout << "quantas alunos pretende adicionar? ";
                cin >> n;
            ...
            //[12] Determinar nota mais alta do aluno perante a disciplina
            case 12: {
                ...
                //Procurar pela nota mais alta do aluno na disciplina
                double result;
                result = stod(disciplinas[escolhaDisciplina-1][escolhaAlunoInt][1]);
                for (int i = 1; i < ((sizeof(disciplinas[0][0])/sizeof(disciplinas[0][0][0]))); i++) {
                    if (disciplinas[escolhaDisciplina-1][escolhaAlunoInt][i] != "") {
                        if( stod(disciplinas[escolhaDisciplina-1][escolhaAlunoInt][i]) > result){
                            result = stod(disciplinas[escolhaDisciplina-1][escolhaAlunoInt][i]);  
                        }
                    }
                }

                //dar print do resultado
                cout << "A nota mais alta do aluno " << disciplinas[0][escolhaAlunoInt][0] << " na disciplina de " << disciplinas[escolhaDisciplina-1][0][0] << " e: "<< result << endl;
